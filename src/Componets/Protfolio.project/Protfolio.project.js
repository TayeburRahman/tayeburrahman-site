    ...
    return (
        ...
        <div className="container dGrid"> 
          ...
          <div className='d-flex' style={{width: '100%', justifyContent:'space-between' }}>
           <Button onClick={()=> handelChang(true)}  disabled={isValue == false} className="SeeLink" style={{color: isValue == false? "rgb(113 122 217)":"#e94914"}}> Close all<AutorenewIcon className='nextIcon'/> </Button> 

           <Button onClick={()=> handelChang(true)} disabled={isValue == true} className="SeeLink" style={{color: isValue == true? "rgb(113 122 217)":"#e94914"}} > See all project<EastIcon className='nextIcon'/> </Button>
           </div>
